<%-- 
    Document   : UploadNotesNew
    Created on : 10-May-2024, 4:52:11 pm
    Author     : ABHINOOR
--%>
...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <form method="post" action="UploadNotesNew.jsp">
                ...
                <div id="uploadSection">
                    <div class="mb-3">
                        <input class="form-control" type="file" id="fileUpload" name="content">
                    </div>
                </div>
